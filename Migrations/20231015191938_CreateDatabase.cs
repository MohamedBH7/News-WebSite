    ...
    public partial class CreateDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            _ = migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_categrories", x => x.Id);
                });
            ...
            _ = migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_contact_Us", x => x.Id);
                });
            ...
            _ = migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: true),
                    Jop_Title = table.Column<string>(nullable: true),
                    Image = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_team_Members", x => x.Id);
                });
            ...
            _ = migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    categroryId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_News", x => x.Id);
                    _ = table.ForeignKey(
                        name: "FK_News_categrories_categroryId",
                        column: x => x.categroryId,
